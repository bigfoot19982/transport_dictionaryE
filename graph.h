...
namespace Graph {
  ...
  // изменил ребро, теперь между остановками куча ребер, каждое из которых для каждого автобуса
  // is_end обозначает, верно ли что в вершине from у нас пересадка в рамках маршрута (конце ветки или кольцевая часть)
  // span ответственнен за подсчет количества остановок, зашитых в ребре от from до to
